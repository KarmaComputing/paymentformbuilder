...
namespace Drupal\webform_product_element\Plugin\WebformElement;
 ...
 *   description = @Translation("Provides a webform product element."),
...
class WebformProductElement extends WebformElementBase {
  ...
  public function prepare(array &$element, WebformSubmissionInterface $webform_submission = NULL) {
    ...
    // FormElement.
    //
    // @see \Drupal\webform_product_element\Element\WebformExampleElement::processWebformElementExample
  }
